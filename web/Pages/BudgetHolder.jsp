...
<html>
    ...
    <div id="mainbody">
      ...
      <div class="panel-heading"><span id="info-span">View the Budget and Expenditure Breakdown</span><br><span id="info-detail">Budget Holder ID - ${param.costc}</span> </div>

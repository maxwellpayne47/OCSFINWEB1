...
<html>
    <head>
        ...
        <script>
            ...
            $(document).ready(function(){
              loadperaccountclass($("#workorder_span").text(),$("#entity_span").text()); 
    ...
    <div id="mainbody">
      ...
      <div style="width:90%; position:relative; margin-left:auto; margin-right:auto;" class="panel panel-primary">      
          <div class="panel-heading"><span id="info-span">View the Budget and Expenditure Breakdown</span><br>Work Order:<span id="workorder_span"> <c:out value="${param.wo}"></c:out></span> Entity - <span id="entity_span"><c:out value="${param.et}"></c:out></span> </div>
      <table class="table table-condensed table-bordered table-hover" id="finweb_htmltbl" border="0">
        <thead id="finweb-header_htmltbl">
          <tr>
            <td>Natural Classification</td>
            <td>Budget</td>
            <td>Actuals</td>
            <td>Commitments</td>
